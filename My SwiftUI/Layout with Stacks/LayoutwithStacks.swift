//
//  LayoutwithStacks.swift
//  My SwiftUI
//
//  Created by rowkaxl on 2021/04/23.
//

import SwiftUI

struct LayoutwithStacks: View {
    var body: some View {
...
struct LayoutwithStacks_Previews: PreviewProvider {
